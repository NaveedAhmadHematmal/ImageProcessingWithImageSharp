...
namespace ImageProcessingWithImageSharp.Templates
{
    ...
    public class FirstTemplate : IImageTemplate
    {
        ...
        public async Task<Image> Generate(GetShareableImageModel campaign)
        {
            ...
            _baseLayer = ImageProcessingCore.DrawTextAtImage(_baseLayer, campaign.CampaignName, Color.White, 35, 274, 1150, 0);

            // writes user names
            _baseLayer = ImageProcessingCore.DrawTextAtImage(_baseLayer, $"@{campaign.CampaignCreatorUsername}", Color.Red, 25, 274, 1200, 0);
            ...
            _baseLayer = ImageProcessingCore.DrawTextAtImage(_baseLayer, $"{campaign.CampaignProgressPercentage}% Completed", Color.White, 25, 274, 1525, 0);
            _baseLayer = ImageProcessingCore.DrawTextAtImage(_baseLayer, $"Ends {campaign.CampaignEndDate}", Color.Red, 25, 710, 1525, 0);
            ...
            _baseLayer = ImageProcessingCore.DrawTextAtImage(_baseLayer, $"${NumberHelper.FormatNumberToString(long.Parse(campaign.CampaignPledgeAmountText))}", Color.Red, 50, 690, 1300, 1);
            _baseLayer = ImageProcessingCore.DrawTextAtImage(_baseLayer, "Pledge", Color.Red, 30, 700, 1360, 0);
